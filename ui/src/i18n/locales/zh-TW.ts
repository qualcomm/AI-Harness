...
export const zh_TW: TranslationMap = {
  ...
  pipelines: {
    ...
    stepCount: "{count} 步",
    new: "+ 新增",
    createFirst: "點擊「新增」建立第一條工作流。",
    pickPrompt: "從左側選擇一條工作流進行編輯。",
    ...
    maxSteps: "最多 {max} 步",
    flowHint:
      "每步收到「原始請求 + 之前每一步的輸出」，各份輸出都標註了步驟號和 agent；某步失敗則中斷，已完成的產出仍會保留。",
    save: "儲存",
    saving: "儲存中…",
    delete: "刪除",
    saveFailed: "儲存失敗",
    deleteFailed: "刪除失敗",
    errConflict: "工作流已被其他地方修改，清單已重新載入最新內容。",
    errNotFound: "該工作流不存在，可能已被刪除。",
    unavailableTitle: "工作流功能不可用",
    unavailableBody:
    ...
    invalid: {
      ...
      no_steps: "至少需要一個步驟。",
      too_many_pipelines: "工作流數量不能超過 {max} 條。",
  ...
  chatMode: {
    ...
    off: "一般對話",
    dynamic: "動態拆解",
    pipelineOption: "工作流：{name}",
    pipelineMissing: "工作流（已失效）",
    noPipelines: "還沒有工作流",
    manage: "管理工作流…",
  },
  taskOrchestrator: {
    ...
    decisionFailed: "送出失敗",
    pipelineCardTitle: "工作流「{name}」執行進度",
    pipelineCardTitleUnnamed: "工作流執行進度",
    pipelineCount: "{count} 步 · {label}",
    pipelineStepsLabel: "工作流步驟（按順序）",
