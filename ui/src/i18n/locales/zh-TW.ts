...
export const zh_TW: TranslationMap = {
  ...
  pipelines: {
    ...
    stepCount: "{count} 步",
    new: "+ 新增",
    createFirst: "點擊「新增」建立第一條流水線。",
    pickPrompt: "從左側選擇一條流水線進行編輯。",
    namePlaceholder: "流水線名稱",
    unsaved: "有未儲存變更",
    saved: "已儲存",
    deleted: "流水線已刪除",
    dragHint: "拖曳排序",
    ...
    agentMissing: "{id}（已失效）",
    instructionPlaceholder: "這一步要做什麼，例如：檢索資料並保留出處",
    addStep: "+ 新增步驟",
    maxSteps: "最多 {max} 步",
    flowHint: "每步收到「原始請求 + 上一步輸出」；某步失敗則中斷，已完成的產出仍會保留。",
    save: "儲存",
    saving: "儲存中…",
    delete: "刪除",
    saveFailed: "儲存失敗",
    deleteFailed: "刪除失敗",
    errConflict: "流水線已被其他地方修改，清單已重新載入最新內容。",
    errNotFound: "該流水線不存在，可能已被刪除。",
    unavailableTitle: "流水線功能不可用",
    unavailableBody:
      "需要啟用 dragon-task-orchestrator 外掛（在設定中將 enabled 設為 true）後重新啟動閘道。",
    invalid: {
      name_empty: "名稱不能為空。",
      name_too_long: "名稱不能超過 {max} 個字元。",
      no_steps: "至少需要一個步驟。",
      too_many_pipelines: "流水線數量不能超過 {max} 條。",
      too_many_steps: "步驟不能超過 {max} 個。",
      step_no_agent: "第 {step} 步未選擇 agent。",
      step_internal_agent: "第 {step} 步不能使用內部 agent「{agentId}」。",
      step_unknown_agent: "第 {step} 步使用的 agent「{agentId}」不存在。",
      step_instruction_too_long: "第 {step} 步的指令超過 {max} 個字元。",
    },
  },
  chatMode: {
    trigger: "執行模式：{mode}",
    off: "一般對話",
    dynamic: "動態拆解",
    pipelineOption: "流水線：{name}",
    pipelineMissing: "流水線（已失效）",
    noPipelines: "還沒有流水線",
    manage: "管理流水線…",
  },
  taskOrchestrator: {
    cardTitle: "任務拆解與執行進度",
    cardCount: "{count} 個子任務 · {label}",
    running: "執行中",
    inProgress: "進行中",
    inProgressEllipsis: "進行中…",
    queued: "等待中",
    notRun: "未執行",
    toBeReplaced: "待替換",
    awaiting: "待確認",
    assigning: "分配中",
    verifyPassed: "校驗 {attempts} 次通過",
    roleVerify: "校驗",
    noCriteria: "無校驗",
    criteriaLabel: "校驗點",
    dependsOn: "← 依賴 {ids}",
    subtasksLabel: "子任務分配（按依賴層級）",
    unscheduled: "未排程（依賴無法滿足）",
    layerN: "第 {layer} 層",
    layerOf: "第 {layer}/{total} 層",
    layerDone: "第 {layer}/{total} 層已完成",
    timelineLabel: "逐層進度",
    failedCount: "{count} 個失敗",
    allPassed: "全部通過",
    execFailed: "執行失敗",
    headerPrevPlan: "原方案",
    headerDecomposed: "拆解完成",
    headerSummarizing: "整合中",
    headerAllLayersDone: "{total} 層已全部完成",
    chipRedecomposing: "重新拆解中",
    summarizingText: "所有子任務已完成{note}，正在整合成最終回覆，請稍候…",
    summarizingNote: "（{ok}/{total} 項成功）",
    redecomposingHead: "正在按你的意見重新拆解…",
    redecomposingHint: "通常需要 30-60 秒，完成後會顯示新的方案",
    confirmQuestion: "是否按此方案執行？",
    confirmHint: "確認後才會開始執行；也可以填寫調整意見，讓拆解重新產生。",
    confirmRun: "確認執行",
    confirmCancel: "取消",
    adjustPlaceholder: "調整意見，例如：把第 2 和第 3 個子任務合併",
    adjustSubmit: "按調整意見重新拆解",
    decisionFailed: "送出失敗",
    pipelineCardTitle: "流水線「{name}」執行進度",
    pipelineCardTitleUnnamed: "流水線執行進度",
    pipelineCount: "{count} 步 · {label}",
    pipelineStepsLabel: "流水線步驟（按順序）",
    stepOf: "第 {step}/{total} 步",
    stepDone: "第 {step}/{total} 步已完成",
    allStepsDone: "{total} 步已全部完成",
    pipelineTimelineLabel: "逐步進度",
  },
  overview: {
    access: {
      title: "網關訪問",
