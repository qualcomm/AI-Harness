...
export const zh_CN: TranslationMap = {
  ...
  pipelines: {
    ...
    stepCount: "{count} 步",
    new: "+ 新建",
    createFirst: "点击「新建」创建第一条流水线。",
    pickPrompt: "从左侧选择一条流水线进行编辑。",
    ...
    addStep: "+ 添加步骤",
    maxSteps: "最多 {max} 步",
    flowHint: "每步收到「原始请求 + 上一步输出」；某步失败则中断，已完成的产出仍会保留。",
    save: "保存",
    saving: "保存中…",
    delete: "删除",
    saveFailed: "保存失败",
    deleteFailed: "删除失败",
    errConflict: "流水线已被其他地方修改，列表已刷新为最新内容。",
    errNotFound: "该流水线不存在，可能已被删除。",
    unavailableTitle: "流水线功能不可用",
    unavailableBody:
    ...
    invalid: {
      ...
      no_steps: "至少需要一个步骤。",
      too_many_pipelines: "流水线数量不能超过 {max} 条。",
  ...
  chatMode: {
    ...
    off: "普通对话",
    dynamic: "动态拆解",
    pipelineOption: "流水线：{name}",
    pipelineMissing: "流水线（已失效）",
    noPipelines: "还没有流水线",
    manage: "管理流水线…",
  },
  taskOrchestrator: {
    ...
    decisionFailed: "提交失败",
    pipelineCardTitle: "流水线「{name}」执行进度",
    pipelineCardTitleUnnamed: "流水线执行进度",
    pipelineCount: "{count} 步 · {label}",
    pipelineStepsLabel: "流水线步骤（按顺序）",
