...
export const de: TranslationMap = {
  ...
  pipelines: {
    ...
    new: "+ New",
    createFirst: "Choose “New” to create your first workflow.",
    pickPrompt: "Select a workflow on the left to edit it.",
    ...
    flowHint:
      "Each step receives the original request plus the output of every earlier step, labelled by step and agent. A failing step aborts the run, and output already produced is kept.",
    save: "Save",
    saving: "Saving…",
    delete: "Delete",
    saveFailed: "Could not save",
    deleteFailed: "Could not delete",
    errConflict: "Workflows changed elsewhere; the list has been refreshed.",
    errNotFound: "That workflow no longer exists; it may have been deleted.",
    unavailableTitle: "Workflows are unavailable",
    unavailableBody:
    ...
    invalid: {
      ...
      too_many_pipelines: "At most {max} workflows are allowed.",
  ...
  chatMode: {
    ...
    pipelineOption: "Workflow: {name}",
    pipelineMissing: "Workflow (missing)",
    noPipelines: "No workflows yet.",
  ...
  taskOrchestrator: {
    ...
    pipelineCardTitle: "Workflow “{name}” progress",
    pipelineCardTitleUnnamed: "Workflow progress",
    pipelineCount: "{count} steps · {label}",
    pipelineStepsLabel: "Workflow steps (in order)",
