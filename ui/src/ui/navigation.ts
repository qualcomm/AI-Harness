...
export const TAB_GROUPS = [
  ...
  { label: "agent", tabs: ["agents", "skills", "nodes", "dreams", "pipelines"] },
  {
    label: "settings",
    tabs: [
      "config",
...
export function iconForTab(tab: Tab): IconName {
  switch (tab) {
    ...
    case "dreams":
      return "moon";
    // Ordering/reordering is what this page is about, and arrowUpDown is the only
    // existing icon that reads that way.
    case "pipelines":
      return "arrowUpDown";
    default:
      return "folder";
