...
1. [Fork](https://github.com/qualcomm/AI-Harness/fork) and clone the repository.

    ```bash
    git clone https://github.com/<username>/AI-Harness.git
    ```
...
1. Create an upstream `remote` to make it easier to keep your branches up-to-date:
    ...
    ```bash
    git remote add upstream https://github.com/qualcomm/AI-Harness.git
    ```
...
1. [Submit a pull request](https://github.com/qualcomm/AI-Harness/pulls) from your branch to `main`.
